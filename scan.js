/*
  Detection-scan panel background(s).
  ...
  Runs on every <canvas data-scan> on the page — the full-height hero
  version on the homepage and the shorter banner version used on
  Writing/Projects/article pages share this same engine; each instance
  sizes itself from its own parent element.
*/
(function () {
  ...
  function mount(canvas) {
    ...
    var SPACING = parseInt(canvas.dataset.spacing, 10) || 52;
  ...
  var canvases = document.querySelectorAll("canvas[data-scan]");
